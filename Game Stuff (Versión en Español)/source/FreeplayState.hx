...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		messageText = new FlxText(scoreText.x -122.5, scoreText.y +100, 0, "Necesitas pasar", 40); //Sí, esto es mucho más perfeccionista que en la versión gringa
		messageText.font = scoreText.font;

		messageText2 = new FlxText(scoreText.x -165, scoreText.y +144, 0, "la semana completa", 40);
		messageText2.font = scoreText.font;

		messageText3 = new FlxText(scoreText.x -135, scoreText.y +188, 0, "para desbloquear", 40);
		messageText3.font = scoreText.font;

		messageText4 = new FlxText(scoreText.x -135, scoreText.y +232, 0, "Extermination :)", 40);
		messageText4.font = scoreText.font;
	
		messageBG = new FlxSprite(messageText.x -52.5, 75).makeGraphic(Std.int(FlxG.width * 0.35), 236, 0xFF000000);
		messageBG.alpha = 0.6;
		add(messageBG);
