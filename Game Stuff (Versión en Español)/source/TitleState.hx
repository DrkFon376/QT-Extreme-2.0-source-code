	...
	override function beatHit()
	{
		...
		switch (curBeat)
		{
			...
			case 4:
				...
				addMoreText('Mod Original');
			// credTextShit.visible = true;
			case 5:
				//createCoolText(['Original game by']);
				addEVENMoreText('hecho por');
			// credTextShit.visible = true;
			case 6:
				createCoolText(['','','Hazard24', 'y', 'CountNightShade']);
			// credTextShit.text += '\npresent...';
			...
			case 8:
				if (Main.watermarks)
					...
					createCoolText(["Compota", "Andere"]);
			case 9:
				if (Main.watermarks)
					addEVENMoreText('hecha por');
				else
					addEVENMoreText('Tevim y Rogelio');
			case 10:
				if (Main.watermarks)
					addMoreText('KadeDeveloper');
				else
				{
					addMoreText("Los Dioses del Funkin'");
					ngSpr.visible = false;
				}
			// credTextShit.text += '\nNewgrounds';
			case 11:
			...
			case 12:
				...
				createCoolText(['DrkFon376 y Marshal']);
			// credTextShit.visible = true;
			case 13:
				addMoreText('Con Dolor en los Dedos');
			case 14:
				//addMoreText(curWacky[1]);
				addEVENMoreText('Presentan');
			// credTextShit.text += '\nlmao';
			case 15:
				deleteCoolText();
			// credTextShit.visible = false;
